      ...
      <Container className="mt-24 sm:mt-32 md:mt-56">
        <FadeIn className="max-w-3xl">
          <h1 className="font-display text-5xl font-medium tracking-tight text-neutral-950 [text-wrap:balance] sm:text-7xl">
            <h1 className="font-display text-5xl font-medium tracking-tight text-neutral-950 [text-wrap:balance] sm:text-7xl">
              Finnian is my brother. He is a dedicated and hardworking
              individual with a passion for technology. His creativity and
              problem-solving skills make him a valuable asset in any team.
            </h1>
          </h1>
